        ...
        {activities.map((activity) => {
          ...
          return (
            <div key={activity.id} className="flex gap-3">
              <div className="flex-shrink-0 w-8 h-8 bg-[#E3ECF8] rounded-full flex items-center justify-center">
                <Icon className="w-4 h-4 text-[#030386]" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="text-xs font-semibold text-[#030386]">
